 ...
 ** Revision date: Sep/10/2016. Can be compiled in Mac.
 */
 ...
 */
void save(struct pakdata *p, unsigned int mode)
{
    unsigned int i;
    unsigned int j;
 ...
 ** Main program
 */
void pletter(unsigned char *data, int length, unsigned char **result, int *result_length)
{
    int i;
    int l;
    int minlen;
